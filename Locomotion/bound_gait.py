...
def forward():
        #leg 4 and leg 1 lift from parallel to lateral
        ...
        #leg 2 and leg 3 lift from lateral to parallel
        ...
        #now equilibrium position is restored
